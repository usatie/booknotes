defmodule TodoServer do
  ...
  def update_entry(entry_id, updater_fun) do
    send(TodoServer, {:update_entry, entry_id, updater_fun})
  end

  def delete_entry(entry_id) do
    send(TodoServer, {:delete_entry, entry_id})
  end

  def entries(date) do
    send(TodoServer, {:entries, self(), date})
    receive do
  ...
  defp process_message(todo_list, {:entries, caller, date}) do
    ...
    todo_list # The state remains unchanged
  end
